...
### Single Prediction Request Body (JSON)
...
```
Request -> JSON Parsing -> DataFrame Conversion -> Pipeline Transform -> Model Predict -> Response
```
...
|  |  |                                                                   |   | |
|  |  |   # Note: kubernetes_sd_configs available but commented out       |   | |
|  |  |   # (optional for K8s-native service discovery)                   |   | |
|  |  +-------------------------------------------------------------------+   | |
|  +--------------------------------------------------------------------------+ |
|                              |                                                |
|                              v                                                |
...
|  |   (Reference)                (Current - Manual Collection)               | |
|  |   +----------+               +----------+                                | |
|  |   |train.csv |               | Collected|                                | |
|  |   |          |               | via      |                                | |
|  |   +----+-----+               | script   |                                | |
...
|  |                   v                                                      | |
|  |   +-------------------------------------------------------------------+  | |
|  |   |           Evidently Streamlit App (app_v1.py)                     |  | |
|  |   |  +---------------------------------------------------------+      |  | |
...
|  +--------------------------------------------------------------------------+ |
|                                                                               |
|  Data Collection (Manual Steps):                                              |
|  +--------------------------------------------------------------------------+ |
|  |  1. Run: python collect_k8s_predictions.py  (optional script)            | |
|  |  2. Run: python fix_k8s_batch.py            (format correction)          | |
|  |  3. Start: streamlit run app_v1.py --server.port 8501                    | |
|  |                                                                          | |
|  |  Note: No automated ingestion from API logs; data collection is manual   | |
|  +--------------------------------------------------------------------------+ |
|                                                                               |
+------------------------------------------------------------------------------+
```
